export class CardBuilder {
    ...
    pattern(codeName, pokemon) {
        ...
        ${(typeof name && typeof name !== 'undefined') ? `<img class='card__image'><img src="${imageUrl}" class="item__img" alt="${name}" loading="lazy" onerror="this.onerror=null;this.src='./assets/0.png';"></div>` : ''}
</div>`;
    }
